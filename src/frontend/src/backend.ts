...
export class Backend implements backendInterface {
    ...
    async addActivityEntry(arg0: [bigint, string, string], arg1: Uint8Array | null, arg2: ExternalBlob | null): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.addActivityEntry(arg0, to_candid_opt_n8(this._uploadFile, this._downloadFile, arg1), await to_candid_opt_n9(this._uploadFile, this._downloadFile, arg2));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async addCheckIn(arg0: DailyCheckIn): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addCheckIn(to_candid_DailyCheckIn_n11(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async addPattern(arg0: Pattern): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addPattern(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async createProgram(arg0: Program): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.createProgram(to_candid_Program_n15(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getActivityEntries(): Promise<Array<OnlineActivityEntry>> {
        if (this.processError) {
            try {
                const result = await this.actor.getActivityEntries();
    ...
    async getActivityEntry(arg0: bigint): Promise<OnlineActivityEntry | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getActivityEntry(arg0);
    ...
    async getHabitLibrary(): Promise<Array<Habit>> {
        if (this.processError) {
            try {
                const result = await this.actor.getHabitLibrary();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async seedHabitLibrary(arg0: Array<Habit>): Promise<void> {
        if (this.processError) {
            try {
...
function from_candid_DailyCheckIn_n39(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _DailyCheckIn): DailyCheckIn {
    return from_candid_record_n40(_uploadFile, _downloadFile, value);
}
function from_candid_DailyProgramEntry_n35(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _DailyProgramEntry): DailyProgramEntry {
...
async function from_candid_OnlineActivityEntry_n22(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _OnlineActivityEntry): Promise<OnlineActivityEntry> {
...
async function from_candid_opt_n27(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_OnlineActivityEntry]): Promise<OnlineActivityEntry | null> {
    return value.length === 0 ? null : await from_candid_OnlineActivityEntry_n22(_uploadFile, _downloadFile, value[0]);
}
...
function from_candid_opt_n31(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_Program]): Program | null {
    return value.length === 0 ? null : from_candid_Program_n32(_uploadFile, _downloadFile, value[0]);
}
...
async function from_candid_record_n23(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        id: value.id,
        externalBlob: record_opt_to_undefined(await from_candid_opt_n24(_uploadFile, _downloadFile, value.externalBlob)),
        sourceLabel: value.sourceLabel,
        notes: value.notes,
        timestamp: value.timestamp,
        image: record_opt_to_undefined(from_candid_opt_n26(_uploadFile, _downloadFile, value.image))
    };
}
function from_candid_record_n33(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    days: Array<_DailyProgramEntry>;
    checkIns: Array<_DailyCheckIn>;
}): {
    days: Array<DailyProgramEntry>;
    checkIns: Array<DailyCheckIn>;
} {
    return {
        ...
        checkIns: from_candid_vec_n38(_uploadFile, _downloadFile, value.checkIns)
    };
}
function from_candid_record_n36(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        task: value.task,
        reflectionPrompt: record_opt_to_undefined(from_candid_opt_n37(_uploadFile, _downloadFile, value.reflectionPrompt))
    };
}
function from_candid_record_n40(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        day: value.day,
        moodRating: record_opt_to_undefined(from_candid_opt_n7(_uploadFile, _downloadFile, value.moodRating)),
        reducedBehavior: value.reducedBehavior,
        notes: value.notes,
...
async function from_candid_vec_n21(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_OnlineActivityEntry>): Promise<Array<OnlineActivityEntry>> {
    return await Promise.all(value.map(async (x)=>await from_candid_OnlineActivityEntry_n22(_uploadFile, _downloadFile, x)));
}
function from_candid_vec_n34(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_DailyProgramEntry>): Array<DailyProgramEntry> {
    return value.map((x)=>from_candid_DailyProgramEntry_n35(_uploadFile, _downloadFile, x));
}
function from_candid_vec_n38(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_DailyCheckIn>): Array<DailyCheckIn> {
    return value.map((x)=>from_candid_DailyCheckIn_n39(_uploadFile, _downloadFile, x));
}
function to_candid_DailyCheckIn_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: DailyCheckIn): _DailyCheckIn {
    return to_candid_record_n12(_uploadFile, _downloadFile, value);
}
function to_candid_DailyProgramEntry_n18(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: DailyProgramEntry): _DailyProgramEntry {
...
function to_candid_Program_n15(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Program): _Program {
...
function to_candid_opt_n8(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Uint8Array | null): [] | [Uint8Array] {
...
function to_candid_record_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        day: value.day,
        moodRating: value.moodRating ? candid_some(value.moodRating) : candid_none(),
        reducedBehavior: value.reducedBehavior,
        notes: value.notes,
        taskCompleted: value.taskCompleted
    };
...
function to_candid_record_n16(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        days: to_candid_vec_n17(_uploadFile, _downloadFile, value.days),
        checkIns: to_candid_vec_n20(_uploadFile, _downloadFile, value.checkIns)
    };
}
function to_candid_record_n19(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        explanation: value.explanation,
        task: value.task,
        reflectionPrompt: value.reflectionPrompt ? candid_some(value.reflectionPrompt) : candid_none()
    };
}
...
function to_candid_vec_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<DailyProgramEntry>): Array<_DailyProgramEntry> {
    return value.map((x)=>to_candid_DailyProgramEntry_n18(_uploadFile, _downloadFile, x));
}
function to_candid_vec_n20(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<DailyCheckIn>): Array<_DailyCheckIn> {
    return value.map((x)=>to_candid_DailyCheckIn_n11(_uploadFile, _downloadFile, x));
}
